 ...
 */
package com.spark.demo.thirdparty.zxing.activity;
...
import com.spark.demo.thirdparty.zxing.utils.BeepManager;
import com.spark.demo.thirdparty.zxing.utils.CaptureActivityHandler;
import com.spark.demo.thirdparty.zxing.utils.InactivityTimer;
...
public final class CaptureActivity extends Activity implements
    ...
    public final String KEY_RICH_SCAN_RESULT="__KEY_RICH_SCAN_RESULT" ;
...
//        }
        ...
        Toast.makeText(this, "扫描到的内容： "+text, Toast.LENGTH_LONG).show();
        Intent intent = new Intent();
        intent.putExtra(KEY_RICH_SCAN_RESULT, text);
...
//            }
//        }).show();
        Log.i(TAG, "=========showConfirmLogin:" + url);
    }
